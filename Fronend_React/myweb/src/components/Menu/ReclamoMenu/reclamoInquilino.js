  ...
  return (
    <div className="container">
      <div className="content">
        <div className="title">
          <h1>Menu de Reclamos - Inquilinos</h1>
        </div>
...
export default ReclamoInquilino;