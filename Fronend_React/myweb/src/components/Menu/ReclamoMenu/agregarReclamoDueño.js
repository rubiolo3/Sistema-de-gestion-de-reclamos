...
import Row from 'react-bootstrap/Row';
    ...
    function AgregarReclamoDueño() {
      ...
      const unidadesDeUsuario = unidades.filter(unidad => unidad.idPropietario == localStorage.getItem('id'));
      ...
      const handleSubmit = async (event) => {
        ...
        try {
          ...
          navigate('/reclamo-dueño'); // Redirigir a la página principal después de guardar la unidad
        } catch (error) {
          console.error('Error:', error);
                ...
                <Row className="mb-3">
                    ...
                    <Form.Group as={Col} md="4" controlId="validationCustom01">
                        <Form.Label>Edificio</Form.Label>
                            ...
                            {/* Muestra los edificios donde el dueño posee unidades */}
                            {edificios.filter(edificio => idEdificiosDeUsuario.includes(edificio.id)).map(edificio => (
...
export default AgregarReclamoDueño;